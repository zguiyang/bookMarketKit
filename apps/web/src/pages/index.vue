      ...
      >
        <div class="flex items-center gap-1 min-w-0 overflow-hidden">
          ...
          <div class="flex items-center gap-1.5 sm:gap-2 min-w-0 overflow-hidden">
            ...
            <span class="text-[10px] font-medium px-1 py-0.5 rounded-sm bg-primary/15 text-primary hidden xs:inline"
              >BETA</span
            >
          </div>
        </div>
    ...
    <main class="flex-1 relative overflow-x-hidden">
      ...
      <section class="relative z-10 overflow-visible py-20 md:py-28 lg:py-36 flex flex-col items-center justify-center">
        <div class="container max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 class="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-tight mb-6">
            智能书签，<span
              class="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent mx-1"
              >AI驱动高效管理</span
            >
          </h1>
          <p class="mt-4 text-lg md:text-xl text-muted-foreground font-light">
            BookmarketKit
            是一款集书签保存、智能分类、内容摘要与多标签管理于一体的现代化书签管理工具。让你的知识收藏更有序、更智能、更高效。
          </p>
      ...
      <section id="features" class="py-20 md:py-28 bg-background/80 relative z-10">
        <div class="container max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 class="mb-14 text-center text-3xl font-extrabold text-foreground md:text-4xl tracking-tight">功能特性</h2>
          <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <p class="text-base text-muted-foreground font-light mb-4">
                一键添加、编辑、删除书签，所有新书签自动进入收藏盒，管理更高效。
              </p>
            ...
            >
              ...
              <p class="text-base text-muted-foreground font-light mb-4">
                AI自动分析书签内容，推荐最优分类，并生成网页内容摘要，快速掌握重点信息。
              </p>
              <div class="flex gap-2 mt-auto">
            ...
            >
              ...
              <p class="text-base text-muted-foreground font-light mb-4">
                支持按标题、URL、描述、标签等多条件搜索，秒速定位所需书签。
              </p>
              <div class="flex gap-2 mt-auto">
