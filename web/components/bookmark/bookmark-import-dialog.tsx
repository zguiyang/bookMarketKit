...
import type { BookmarkImportResponse } from '~shared/schemas';
import { uploadBizTypes } from '~shared/schemas';
...
const BookmarkImportDialog: React.FC<BookmarkImportDialogProps> = ({
  ...
  const importBookmarks = async () => {
    ...
    try {
      ...
      // 发送上传请求
      const uploadResponse = await startUpload(uploadBizTypes.BOOKMARK, formData);
