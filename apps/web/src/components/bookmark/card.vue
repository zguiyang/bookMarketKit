...
<template>
    <u-card
        ...
        border-gray-100 dark:border-gray-700 sm:p-2 bg-white dark:bg-gray-800"
    >
      <div class="flex items-center justify-between mb-3 sm:mb-2">
        ...
        <div class="flex items-center space-x-1">
          <u-button
              variant="ghost"
              size="sm"
              :icon="bookmark.isFavorite === 1 ? 'i-heroicons-heart-solid' : 'i-heroicons-heart'"
              :class="[
              'size-8 sm:size-7',
              'cursor-pointer transition-colors',
              { 'text-red-500 hover:text-red-600': bookmark.isFavorite === 1 }
            ]"
              square
          />
          <u-button
              variant="ghost"
              size="sm"
              :icon="bookmark.isPinned === 1 ? 'i-heroicons-map-pin-solid' : 'i-heroicons-map-pin'"
      ...
      <div v-if="bookmark.description" class="mb-3">
        <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed line-clamp-2 group-hover:line-clamp-none transition-all duration-200">
      ...
      <div class="absolute inset-0 bg-gradient-to-t from-black/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />
