...
import { BookmarkFavoriteEnum, BookmarkPinnedEnum } from '~shared/schemas/bookmark';
...
import type { FormValues } from './bookmark-form';
import type { UpdateBookmarkBody } from '~shared/schemas';
