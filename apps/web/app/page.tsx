        ...
        <div className="container flex h-14 max-w-screen-xl mx-auto px-2 sm:px-4 lg:px-8 items-center justify-between flex-nowrap min-w-0">
          <div className="flex items-center gap-1 min-w-0 overflow-hidden">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2 min-w-0 overflow-hidden">
              ...
              <span className="text-[10px] font-medium px-1 py-0.5 rounded-sm bg-primary/15 text-primary hidden xs:inline">
                BETA
              </span>
            </div>
          </div>
        ...
        <section className="relative z-10 overflow-visible py-20 md:py-28 lg:py-36 flex flex-col items-center justify-center">
          <div className="container max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight leading-tight mb-6">
              智能书签，
              <span className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent mx-1">
                AI驱动高效管理
              </span>
            </h1>
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link href="/auth/sign-up">
                <Button
                  size="lg"
                  className="h-10 px-8 text-base rounded-lg bg-gradient-to-r from-primary via-blue-500 to-pink-500 text-white font-bold shadow-md transition-all duration-200 hover:scale-105 gap-2 cursor-pointer"
                >
              ...
              <Link href="#features">
                <Button
                  variant="outline"
                  size="lg"
                  className="h-10 px-8 text-base rounded-lg border-2 border-primary text-primary font-bold transition-all duration-200 hover:bg-primary/10 hover:text-primary-700 cursor-pointer"
                >
                  产品特性
                </Button>
              </Link>
          ...
          <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="relative group rounded-2xl border border-primary/10 bg-white/70 dark:bg-card/80 p-8 shadow-xl flex flex-col min-h-[220px] transition-all duration-200 hover:shadow-2xl hover:border-2 hover:border-sky-400/70">
                <span className="absolute top-4 right-4 px-3 py-1 text-xs font-semibold rounded-full bg-yellow-100 text-yellow-700 shadow-sm">
                  开发中
                </span>
          ...
          <div className="container max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link href="/auth/sign-up">
                <Button
                  size="lg"
                  className="h-10 px-8 text-base rounded-lg bg-gradient-to-r from-primary via-blue-500 to-pink-500 text-white font-bold shadow-md transition-all duration-200 hover:scale-105 w-full sm:w-auto cursor-pointer"
                >
                  注册账户
                </Button>
              </Link>
              <Link href="/auth/sign-in">
                <Button
                  variant="outline"
                  size="lg"
                  className="h-10 px-8 text-base rounded-lg border-2 border-primary text-primary font-bold transition-all duration-200 hover:bg-primary/10 hover:text-primary-700 w-full sm:w-auto cursor-pointer"
                >
                  登录账户
                </Button>
              </Link>
      ...
      <footer className="border-t py-8 md:py-10 bg-background/90">
        <div className="container max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <div className="text-sm text-muted-foreground">
            有问题？请联系我们：
            <a href="mailto:2770723534@qq.com" className="hover:underline">
              2770723534@qq.com
            </a>
          </div>
        </div>
